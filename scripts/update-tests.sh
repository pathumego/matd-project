...
fontforge ../../scripts/fontconvert experiment-latin-cursive-0.sfd --remove-overlap --otf
...
fontforge ../../scripts/fontconvert experiment-latin-opt-2.sfd --remove-overlap --otf
...
fontforge ../../scripts/fontconvert experiment-sinhala-opt-0.sfd --remove-overlap --ot
...
fontforge ../../scripts/fontconvert Greek-Regular.sfd --remove-overlap --otf
